...
kubectl delete lifecyclepolicy.ecr.aws.upbound.io --all --force
kubectl delete pullthroughcacherule.ecr.aws.upbound.io --all --force
kubectl delete registrypolicy.ecr.aws.upbound.io --all --force
kubectl delete registryscanningconfiguration.ecr.aws.upbound.io --all  --force
kubectl delete repository.ecr.aws.upbound.io --all --force
kubectl delete repositorypolicy.ecr.aws.upbound.io --all --force
kubectl delete registryscanningconfiguration.ecr.aws.upbound.io --all --force
